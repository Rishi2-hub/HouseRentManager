...
export function BillsScreen({
  ...
  // Keep the bill form compact. The tenant list stays collapsed
  // until the owner taps the selector.
      ...
      <Card>
        ...
        {tenants.length === 0 ? (
          ...
          <View style={styles.tenantPickerWrap}>
            <Pressable
              onPress={() =>
                setTenantPickerOpen((value) => !value)
              }
              style={({ pressed }) => [
                styles.tenantSelector,
                tenantPickerOpen &&
                  styles.tenantSelectorOpen,
                pressed && styles.tenantSelectorPressed,
              ]}
            >
              <Text
                numberOfLines={1}
                style={[
                  ...
                  !selectedTenant &&
                    styles.tenantSelectorPlaceholder,
                ]}
              >
                {selectedTenant
              ...
              <Text style={styles.tenantSelectorChevron}>
                {tenantPickerOpen ? '▲' : '▼'}
              </Text>
            </Pressable>

            {tenantPickerOpen && (
              <View style={styles.tenantDropdown}>
                    ...
                    <Pressable
                      ...
                      style={({ pressed }) => [
                        ...
                        index < tenants.length - 1 &&
                          styles.tenantOptionBorder,
                        selected &&
                          styles.tenantOptionSelected,
                        pressed &&
                          styles.tenantOptionPressed,
                      ]}
                    >
                      <Text
                        numberOfLines={1}
                      ...
                      {selected && (
                        <Text style={styles.tenantOptionCheck}>
                          ✓
                        </Text>
                      )}
                    </Pressable>
